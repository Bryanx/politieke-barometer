...
namespace Barometer.Models {
    public class Persoon {
        ...
        public static IEnumerable<Persoon> getPersonen() {
            ...
            list.Add(new Persoon(6,"Robbe", "Dillen", rnd.Next(1, 34930), rnd.Next(1, 34930), rnd.Next(1, 34930), rnd.Next(1, 34930)));list.Add(new Persoon(1,"Bryan", "Knight", rnd.Next(1, 34930), rnd.Next(1, 34930), rnd.Next(1, 34930), rnd.Next(1, 34930)));
            ...
            list.Add(new Persoon(11,"Robbe", "Dillen", rnd.Next(1, 34930), rnd.Next(1, 34930), rnd.Next(1, 34930), rnd.Next(1, 34930)));list.Add(new Persoon(1,"Bryan", "Knight", rnd.Next(1, 34930), rnd.Next(1, 34930), rnd.Next(1, 34930), rnd.Next(1, 34930)));
            ...
            list.Add(new Persoon(16,"Robbe", "Dillen", rnd.Next(1, 34930), rnd.Next(1, 34930), rnd.Next(1, 34930), rnd.Next(1, 34930)));list.Add(new Persoon(1,"Bryan", "Knight", rnd.Next(1, 34930), rnd.Next(1, 34930), rnd.Next(1, 34930), rnd.Next(1, 34930)));
            ...
            list.Add(new Persoon(21,"Robbe", "Dillen", rnd.Next(1, 34930), rnd.Next(1, 34930), rnd.Next(1, 34930), rnd.Next(1, 34930)));list.Add(new Persoon(1,"Bryan", "Knight", rnd.Next(1, 34930), rnd.Next(1, 34930), rnd.Next(1, 34930), rnd.Next(1, 34930)));
